...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let bgActiveSetting = ImageAsset(name: "bg_active_setting")
    ...
    internal static let icArrowExpand = ImageAsset(name: "ic_arrow_expand")
    ...
    internal static let icArrowToTop = ImageAsset(name: "ic_arrow_to_top")
    ...
    internal static let icGame = ImageAsset(name: "ic_game")
    ...
    internal static let icKey = ImageAsset(name: "ic_key")
    internal static let icLaptop = ImageAsset(name: "ic_laptop")
    ...
    internal static let icProfileUser = ImageAsset(name: "ic_profile_user")
    ...
    internal static let icTickActive = ImageAsset(name: "ic_tick_active")
    ...
    internal static let introImage = ImageAsset(name: "intro_image")
  ...
  internal enum Colors {
    ...
    internal static let popoverBgColor = ColorAsset(name: "PopoverBgColor")
    internal static let popoverBgSelected = ColorAsset(name: "PopoverBgSelected")
    ...
    internal static let bgButtonColor = ColorAsset(name: "bgButtonColor")
    ...
    internal static let buttonCancelColor = ColorAsset(name: "buttonCancelColor")
    ...
    internal static let secondary3 = ColorAsset(name: "secondary3")
